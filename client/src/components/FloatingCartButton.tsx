...
export default function FloatingCartButton({ onClick }: { onClick: () => void }) {
  ...
  return (
    <button
      onClick={onClick}
      className="fixed bottom-6 right-6 z-50 p-0 rounded-full shadow-lg flex items-center justify-center"
      aria-label="Abrir carrinho"
      style={{ boxShadow: "0 4px 12px rgba(0,0,0,.18)", background: "rgba(238, 165, 48, 0.85)" }}
    >
